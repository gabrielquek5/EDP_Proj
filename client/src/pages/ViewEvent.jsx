...
function ViewEvent() {
  ...
  const reportReview = (dialogId) => {
    ...
    http
      .put(`/reviews/${dialogId}/report-review`)
      .then((res) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (data) => {
      ...
      const selectedDateTime = dayjs.tz(
        `${data.cartSelectedDate.format(
          "YYYY-MM-DD"
        )} ${data.cartSelectedTime.format("HH:mm:ss")}`,
        "Asia/Singapore"
      );
          ...
          <Grid container spacing={3}>
            <Grid item xs={8}>
              <div>
                ...
                <Typography sx={{ fontFamily: "Poppins" }}>
                  Time: {dayjs(schedule.selectedTime, "HH:mm:ss").format("HH:mm A")}
                </Typography>
                <Typography sx={{ fontFamily: "Poppins" }}>
                      ...
                      <Box sx={{ my: 4 }}>
                        <Box sx={{ width: "100%" }}>
                          <DatePicker
                            ...
                            onChange={(newDate) =>
                              formik.setFieldValue("cartSelectedDate", newDate)
                            }
                            slotProps={{
                              textField: {
                                error:
                        ...
                        <Box sx={{ mt: 4, width: "100%" }}>
                          <TimePicker
                            ...
                            onChange={(newTime) =>
                              formik.setFieldValue("cartSelectedTime", newTime)
                            }
                            slotProps={{
                              textField: {
                                error:
